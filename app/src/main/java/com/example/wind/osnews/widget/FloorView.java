package com.example.wind.osnews.widget;
...
public class FloorView extends LinearLayout {
     ...
     */
    public void setComments(List<DetailComment.ResultBean.ItemsBean> refers) {
        // 清除子View
        removeAllViews();
     ...
     */
    private void initViewWithAll(List<DetailComment.ResultBean.ItemsBean> refers) {
     ...
     * @param comments 评论数据列表
     */
    private void initViewWithHide(final List<DetailComment.ResultBean.ItemsBean> refers) {
     ...
     * @return 一个评论子视图
     */
    private View getView(DetailComment.ResultBean.ItemsBean refer, int index, int count, boolean isHide) {
        // 获取根布局
        ...
        if (isHide) {
            ...
            // 设置显示数据
            tvUserName.setText(refer.getContent());
...
//            tvContent.setMovementMethod();
            ...
            Spanned rcontent = Html.fromHtml(refer.getContent());
